 ...
 */
final class Version20220418114505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD title VARCHAR(50) NOT NULL');
